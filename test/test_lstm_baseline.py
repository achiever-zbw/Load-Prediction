...
def main():
    ...
    checkpoint_path = "saved/checkpoints/lstm_baseline_best.pth"
    scaler_dir = "saved/scaler/lstm"
    time_step = 24
    ...
    # 5. 模型初始化与权重加载
    model = LSTMBaseline(dim=64, hidden_dim=128, num_layers=2, dropout=0.2, time_step=time_step).to(device)
