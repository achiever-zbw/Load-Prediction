...
def main():
    ...
    checkpoint_path = "saved/checkpoints/best_none_channel_trans_main_model.pth"
    scaler_dir = "saved/scaler/none_channel_trans_main"
    time_step = 24
    ...
    # 6. 开始评估
    evaluate_nonn_channel_main(model, test_dataloader, device, save_dir=scaler_dir , pic_name="None_Channel_Trans")
