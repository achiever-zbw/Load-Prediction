...
def main():
    ...
    save_path = "saved/checkpoints/best_none_channel_attn_model.pth"
    ...
    # 4. model 初始化 - 使用无通道注意力模型
    model = NoneChannelAttnModel(dim=64, time_step=48).to(device)
    ...
    plt.title('NoneChannelAttnModel - Training and Validation Loss', fontsize=14)
    plt.legend(fontsize=10)
    plt.grid(True, alpha=0.3)
    plt.tight_layout()

    # 保存图像
    loss_curve_path = 'saved/none_channel_attn_loss_curve.png'
